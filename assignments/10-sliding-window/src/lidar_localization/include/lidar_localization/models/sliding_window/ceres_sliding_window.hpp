...
public: 
    static const int INDEX_P = 0;     // 位置偏差维度
    static const int INDEX_R = 3;     // 旋转位姿偏差维度
    static const int INDEX_V = 6;     // 速度偏差维度
    static const int INDEX_A = 9;     // 加速度计偏差维度
    static const int INDEX_G = 12;    // 陀螺仪偏差维度
