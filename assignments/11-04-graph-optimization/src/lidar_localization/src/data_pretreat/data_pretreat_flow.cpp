...
bool DataPretreatFlow::ReadData() {
    ...
    //std::cout << "valid_odom is " << valid_odom ;
    //std::cout << "valid_gnss is " << valid_gnss ;
    //std::cout << "valid_imu is " << valid_imu << std::endl;
...
bool DataPretreatFlow::TransformData() {
    ...
    current_velocity_data_.angular_velocity.x =
        current_imu_data_.angular_velocity.x;
    current_velocity_data_.angular_velocity.y =
        current_imu_data_.angular_velocity.y;
    current_velocity_data_.angular_velocity.z =
...
bool DataPretreatFlow::PublishData() {
    ...
    gnss_pub_ptr_->Publish(gnss_pose_, current_velocity_data_,
